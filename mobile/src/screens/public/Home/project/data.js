const projets = [
  ...
  {
    id: 2,
    name: 'Prévision des Rendements des Cultures',
    price: '200.000',
    like: false,
    img: require('../../../../../assets/im2.webp'),
    about:
      'Ce projet utilise des modèles prédictifs pour estimer les rendements des cultures. En analysant les données météorologiques et du sol, la Prévision des Rendements aide les agriculteurs à prendre des décisions éclairées pour la plantation et la récolte.',
  },
  {
    id: 3,
  ...
  {
    id: 4,
    name: 'Optimisation des Cultures',
    price: '175.000',
    like: true,
    img: require('../../../../../assets/im3.webp'),
    about:
      'Un projet d’Optimisation des Cultures visant à maximiser les rendements en utilisant des techniques modernes. Ce projet propose des analyses basées sur les données pour aider les agriculteurs à améliorer leurs pratiques agricoles.',
  },
