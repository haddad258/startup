...
const ApiSupperSettings = {
  ...
  api_PaymentCardsCustomers: `${API_URL}/api/card/payments/customers/`,
  api_OrdersCustomers: `${API_URL}/api/customers/orders/list/`,
  ...
  api_ProfilesIdCryptes: `${API_URL}/api/configs/cryptes/profiles/keys/`,
  
  ///////////////////////////////////////////////////////////////
  api_StatusOrders: `${API_URL}/api/accounts/status/orders/`,
  api_Orders: `${API_URL}/api/accounts/list/orders/`,
  api_TransactionsOrders: `${API_URL}/api/accounts/paypals/transactions/`,
  api_OrdersByIdTransactions: `${API_URL}/api/accounts/list/orders/by/order/`,
