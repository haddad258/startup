                ...
                <CModalBody>
                    ...
                    >
                        ...
                        <CCol md={12} className="position-relative">
                            ...
                            <CFormInput value={Placks.description} onChange={(e) => setFormdata({ ...Placks, description: e.target.value })} type="text" id="validationTooltip03" required />
                            <CFormFeedback tooltip invalid>
                        ...
                        <CCol md={6} className="position-relative">
                            <CFormLabel htmlFor="location">{i18n.t('locationLabel')} (pays)</CFormLabel>
                            <CFormInput
