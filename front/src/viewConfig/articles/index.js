...
import ArticlesConfigsC from './Articles.Config';
const Articles = () => {
    ...
    const columns = [
        ...
        {
            label: 'barcodeInputLabel', field: 'barcode',
            render: (item) => (
        <>
        ...
        {
            label: i18n.t('ConfigFilter'),
            field: 'actions',
            render: (item) =>
                <>
                    <ArticlesConfigsC refresh={() => fetchArticles()} selectedArticlesConfigs={item} />
                </>
        },
