                ...
                <CModalBody>
                    ...
                    >
                        ...
                        <CCol md={12} className="position-relative">
                            ...
                            <CFormInput value={StatusOrder.description} onChange={(e) => setFormdata({ ...StatusOrder, description: e.target.value })} type="text" id="validationTooltip03" required />
                            <CFormFeedback tooltip invalid>
                            {i18n.t('requiredDescriptionField')}
                            </CFormFeedback>
                        </CCol>
                        <CCol md={12} className="position-relative">
                            <CFormLabel htmlFor="validationTooltip05">{i18n.t('eventsInputLabel')}</CFormLabel>
                            <CFormInput value={StatusOrder.events} onChange={(e) => setFormdata({ ...StatusOrder, events: e.target.value })} type="number" step="0.01" id="validationTooltip05" required />
                            <CFormFeedback tooltip invalid>
                                {i18n.t('requiredeventsField')}
                            </CFormFeedback>
                        </CCol>
                        <CModalFooter>
