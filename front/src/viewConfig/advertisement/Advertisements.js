                    ...
                    >
                        ...
                        <CCol md={12} className="position-relative">
                            ...
                            >
                                ...
                                <option value="popup">{i18n.t('firstBanner')}</option>
                                <option value="popup">{i18n.t('secondBanner')}</option>
                                <option value="popup">{i18n.t('thirdBanner')}</option>
                                <option value="popup">{i18n.t('bannerCenter')}</option>
