...
const OrdersTransactions = React.lazy(() => import('src/viewConfig/orders/order.transactions'))
...
const RouteConfig = [
  ...
  { path: '/accounts/transactions/details/orders', name: 'OrdersTransactions', element: OrdersTransactions },
