...
import { OrderSettings, PosAPI } from '../../../../service/doctype';
import { formatDate } from '../../../../core/helpers/formdate';

function CartPosScreen({ navigation }) {
  ...
  const handleOrderCreation = async () => {
    try {
      ...
      const response = await PosAPI.addpos(payload);
      if (response) {
        alert('Order Created');
