...
const AuthLogin = ({ ...rest }) => {
  ...
  const { login } = useContext(AuthContext); // Using the AuthContext
  ...
  const handleLogin = async (values, { setSubmitting, setErrors }) => {
    try {
      const response = await login(values.email, values.password); // Using the AuthContext
      ...
      if (response) {
        ...
        setErrors({ submit: 'Nom d\'utilisateur ou mot de passe incorrect' });
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      <Formik
        ...
        onSubmit={handleLogin}  // Utiliser handleLogin dans onSubmit
      >
